                                        ...
                                        agent.get('/api/restockOrders/1/returnItems')
                                            .then(function (res) {
                                                ...
                                                let retOrder = ({
                                                    ...
                                                    products: [{ "SKUId": 1, "itemId": 1, "description": "a product", "price": 10.99, "RFID": "12345678901234567890123456789015" },
                                                    { "SKUId": 1, "itemId": 1, "description": "another product", "price": 11.99, "RFID": "12345678901234567890123456789016" },
                                                    { "SKUId": 1, "itemId": 1, "description": "another product", "price": 11.99, "RFID": "12345678901234567890123456789017" }],
                                                    restockOrderId: 1
                                                });
